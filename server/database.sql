...
--fake users data
insert into users (user_name, user_email, user_password) values ('discky', 'discky@gmail.com', '12345');
insert into users (user_name, user_email, user_password) values ('jacob', 'jacob@gmail.com', '321321');

--fake todos data
insert into todos (user_id, description) values ('4068a3d1-82bb-4d40-8775-69dd93366517', 'Eating hotdog');
